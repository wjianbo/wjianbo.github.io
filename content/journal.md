...
- 上周去了 vimmer 线下活动之后，心理起了奇怪的变化：我想改用 helix 了。
- vimmer 现在分成两派，一派是坚持用旧的 vim，另一派用后起之秀 neovim。
- 无论是 vim 还是 neovim，都难免要折腾配置。
- 之前一直对 vim 和 neovim 的区别没有实感。
- 这两天想了一下，区别大概是，vim 插件用 vimscript 写成，只要放在目录下就可以用。
- neovim 的插件支持更多编程语言，相应地对环境更多依赖。
- 而 helix 可以说是开箱即用。
- helix 用 Rust 写成，也许有机会看懂代码，成为 contributor。
- 说到底还是喜欢 Rust？
## 2023-08-27
- 看《海贼王》
- 读《1984》
